    ...
    AVIMClient.setSignatureFactory(new KeepAliveSignatureFactory());
      ...
      AVIMMessageManager.registerDefaultMessageHandler(new AVIMMessageHandler() {
          ...
          public void onMessage(AVIMMessage message) {
              ...
              Intent resultIntent = new Intent(getApplicationContext(), PrivateConversationActivity.class);
              ...
              PendingIntent pi =
                      PendingIntent.getActivity(getApplicationContext(), -1, resultIntent, PendingIntent.FLAG_ONE_SHOT);
